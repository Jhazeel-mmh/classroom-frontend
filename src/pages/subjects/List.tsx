...
import { DEPARTMENTS_OPTIONS } from '@/constants/departments'
        ...
        columns: useMemo<ColumnDef<Subject>[]>(() => [
            {
                ...
                accessorKey: 'code',
                size: 100,
                header: () => <p className='colum-title ml-2'>Code</p>,
                ...
                <div className='flex gap-2 w-full sm:w-auto'>
                    <Select value={selectedDepartment} onValueChange={setSelectedDepartment}>
                        ...
                        <SelectContent>
                            ...
                            {
                                DEPARTMENTS_OPTIONS.map(dept => <SelectItem value={dept.value} key={dept.value}>{dept.label}</SelectItem>)
                            }
                        </SelectContent>
                    </Select>
                    <CreateButton />
